class DashboardModel {
  ...
  factory DashboardModel.fromJson(Map<String, dynamic> json) {
    return DashboardModel(
      ...
      graficoFaturamento: (json['graficoFaturamento'] as List<dynamic>?)
              ?.map((e) => FaturamentoMensalModel.fromJson(e))
              .toList() ??
          [],
      graficoServicos: (json['graficoServicos'] as List<dynamic>?)
              ?.map((e) => ServicosMensalModel.fromJson(e))
              .toList() ??
          [],
      ordensRecentes: (json['ordensRecentes'] as List<dynamic>?)
              ?.map((e) => OrdemRecenteModel.fromJson(e))
              .toList() ??
          [],
      estoqueBaixo: (json['estoqueBaixo'] as List<dynamic>?)
              ?.map((e) => EstoqueBaixoModel.fromJson(e))
              .toList() ??
          [],
      agendamentos: (json['agendaHoje'] as List<dynamic>?)
