...
import 'package:oficina_conectada_front/controllers/cliente/cliente_controller.dart';
...
class _ClientesViewState extends State<ClientesView> {
  late ClienteController _controller;
  String _searchQuery = '';
  ...
  void initState() {
    super.initState();
    _controller = ClienteController(ClienteService());
    _controller.add(CarregarClientes());
  }
  ...
  void _enviarFormulario() {
    ...
    final temCarro =
        _placaController.text.isNotEmpty || _modeloController.text.isNotEmpty;
    ...
    if (temCarro) {
      ...
      _controller.add(AdicionarClienteComCarro(dto));
    } else {
      ...
      _controller.add(AdicionarClienteSimples(cliente));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocConsumer<ClienteController, ClienteState>(
        bloc: _controller,
        ...
        builder: (context, state) {
          ...
          return Column(
            ...
            children: [
              ...
              Expanded(
                child:
                    state is ClienteLoading && clientes.isEmpty
              ...
              Row(
                ...
                children: [
                  ...
                  PopupMenuButton<String>(
                    ...
                    onSelected: (value) {
                      if (value == 'excluir') {
                        _controller.add(DeletarCliente(client.id!));
                      }
                    },
                    itemBuilder:
                        (context) => [
