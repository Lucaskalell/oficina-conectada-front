...
import 'package:oficina_conectada_front/controllers/dashboard/dashboard_controller.dart';
...
class _DashboardViewState extends State<DashboardView> {
  ...
  void initState() {
    super.initState();
    _controller = DashboardController(DashboardService());
    _controller.add(CarregarDashboard());
  }
      ...
      body: BlocBuilder<DashboardController, DashboardState>(
        ...
        builder: (context, state) {
          if (state is DashboardLoading || state is DashboardInitial) {
            return const Center(
              child: CircularProgressIndicator(color: ColorsApp.greenNew),
            );
          }
          ...
          if (state is DashboardLoaded) {
            final dados = state.dashboardData;

            return RefreshIndicator(
              onRefresh: () async => _controller.add(CarregarDashboard()),
    ...
    return Row(
      ...
      children: [
        ...
        Expanded(
          ...
          child: Column(
            children: [
              _buildTodaySchedule(dados.agendamentos),
              const SizedBox(height: 24),
              ...
              children: [
                ...
                Row(
                  children: const [
                    Text(
                      'Ver todas',
                      style: TextStyle(color: ColorsApp.greenNew, fontSize: 13),
                    ),
