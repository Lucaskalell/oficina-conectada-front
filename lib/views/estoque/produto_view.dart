...
import 'package:oficina_conectada_front/controllers/estoque/produto_controller.dart';
...
class _ProdutoViewState extends State<ProdutoView> {
      ...
      create:
          (context) =>
              ProdutoController(ProdutoService())
                ..add(BuscarProdutos(widget.subCategoriaId)),
      child: Scaffold(
        ...
        body: BlocConsumer<ProdutoController, ProdutoState>(
  ...
  Widget _buildContent(BuildContext context, List<ProdutoModel> produtosApi) {
    final listaFiltrada =
        produtosApi.where((prod) {
          final matchSearch = prod.nome.toLowerCase().contains(
          ...
          child: Column(
            ...
            children: [
              ...
              SingleChildScrollView(
                ...
                child: Row(
                  children:
                      ['Todos', 'Dianteiro', 'Traseiro', 'Esquerdo', 'Direito']
                          .map((filtro) {
                            ...
                            return Padding(
                              ...
                              child: FilterChip(
                                ...
                                onSelected:
                                    (bool selected) =>
                                        setState(() => _filtroPosicao = filtro),
  ...
  void _mostrarModal(BuildContext context, {ProdutoModel? produtoParaEditar}) {
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        if (isEdicao) {
                          context.read<ProdutoController>().add(
          ...
          (dialogContext) => AlertDialog(
            ...
            actions: [
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  context.read<ProdutoController>().add(
                    DeletarProduto(id, widget.subCategoriaId),
                  );
                  Navigator.pop(dialogContext);
                },
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton(
            onPressed:
                () => context.read<ProdutoController>().add(
                  BuscarProdutos(widget.subCategoriaId),
                ),
